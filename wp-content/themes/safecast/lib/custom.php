...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				'key' => 'field_5826ea6dbb4e0',
				'label' => 'PM2.5 Last',
				'name' => 'sensor_measurement_last_pm25',
				'type' => 'number',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5826eb461273f',
				'label' => 'PM2.5 max',
				'name' => 'sensor_measurement_max_pm25',
				'type' => 'number',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
...
<table id="sensors" class="table table-striped footable toggle-arrow-tiny" data-page-size="50" data-filter="#filter" data-filter-text-only="true">
    ...
    'pm25',
		...
		foreach ($sensors as $sensor) {
   		...
   		$pm25        = addslashes($sensor['measurement']['pm25']);   
        ...
        <td><span class="measure-pm25">%s</span></td>
	...
	$id, $permalink, $location, $id, $timestamp, $timeAgo, $timeGMT, $usievert, $cpm,$pm25,
...
if (!function_exists('getAllSensors')) {
	function getAllSensors() {
		...
		if ($query->have_posts()) {
          ...
          'pm25'           => get_post_meta(get_the_ID(), 'sensor_measurement_last_pm25', 		true),
...
if (!function_exists('generateMap')) {
	function generateMap($sensors, $lang = 'en') {
      ...
      $pm25         = addslashes($sensor['measurement']['pm25']);
			...
			", $id, $permalink, $timeAgo, $location, $latitude, $longitude, $cpm, $usvh, $pm25, $graphPath, $status);
		}
