...
<h3>I look Forward to Working with you</h3>
  ...
  <div class="row" style="margin-left:10px;background:#fff;text-align:center">
	...
	<a class="btn btn-danger  btn-large" href="http://easycomingsoon.com/" target="_new"><?php _e('Upgrade To Pro Version','easymaintenance');?></a>&nbsp;
	<a class="btn btn-success  btn-large" href="http://easycomingsoon.com/demos/" target="_new"><?php _e('View Live demo','easymaintenance');?></a>
	</div> 
	<br>	
