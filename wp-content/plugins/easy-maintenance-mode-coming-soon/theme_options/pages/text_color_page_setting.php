...
<?php $current_options = wp_parse_args( get_option( 'easy_maintenance_mode_text_design_setting', array() ), text_design_setting() );
	...
	<form method="post" action="#section_text-color">
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Headline Font Color','easymaintenance');?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Description Font Color','easymaintenance');?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Headline Font size','easymaintenance');?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Description Font size','easymaintenance');?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Headline Font Style','easymaintenance');?></h3>
