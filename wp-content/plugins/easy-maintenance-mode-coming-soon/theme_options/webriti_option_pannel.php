...
<div class="wrap settings-wrap" id="page-settings">
    ...
    <div id="option-tree-header-wrap">
        <ul id="option-tree-header">
			...
			<a style="margin-right:16px;" target="_blank" href="http://easycomingsoon.com/" class="button button-primary button-large fb-btn"><?php _e('Upgrade to Pro version','easymaintenance'); ?></a>
    ...
    <div id="option-tree-sub-header"></div>
        <div class = "ui-tabs ui-widget ui-widget-content ui-corner-all">
            <ul>
				...
				<li id="tab_pricing_setting"><a href="#section_pricing_version"><?php _e('Pricing','easymaintenance');?></a>
                </li>
	...
	<div class="webriti-submenu" style="height:35px;">			
			...
			<form method="POST">
				<input type="submit" onclick="return confirm( 'Click OK to reset theme data. Theme settings will be lost!' );" value="<?php _e('Restore All Defaults','easymaintenance'); ?>" name="restore_all_defaults" id="restore_all_defaults" class="reset-button btn">
			<form>
