...
//		$this->add_library['amcharts'] = false;
...
//				break;
	...
	public function register_highcharts_scripts() {
		//$lib_path = BC_PLUGIN_PATH .  "js/highcharts/highcharts.js";
		//$lib_url = BC_PLUGIN_URL .  "js/highcharts/highcharts.js";
		//$lib_path = str_replace('\\', '/', $lib_path);
		//if ($this->options['highcharts_cdn'] === '1' || !file_exists($lib_path) ) {
			$lib_url = "http://code.highcharts.com/highcharts.js";
		//}
		...
		foreach ($arr as $value) {
			switch ($value) {
				case "more":
					//$lib_path = BC_PLUGIN_PATH .  "js/highcharts/highcharts-more.js";
					//$lib_url = BC_PLUGIN_URL .  "js/highcharts/highcharts-more.js";
					//if ($this->options['highcharts_cdn'] === '1' || !file_exists($lib_path) ) {
						$lib_url = "http://code.highcharts.com/highcharts-more.js";
					//}
					wp_register_script("highcharts-more", $lib_url, array("jquery", "highcharts"), '1.0', true);
					wp_enqueue_script('highcharts-more');
					break;
				case "3d":
					//$lib_path = BC_PLUGIN_PATH .  "js/highcharts/highcharts-3d.js";
					//$lib_url = BC_PLUGIN_URL .  "js/highcharts/highcharts-3d.js";
					//if ($this->options['highcharts_cdn'] === '1' || !file_exists($lib_path) ) {
						$lib_url = "http://code.highcharts.com/highcharts-3d.js";
					//}
					wp_register_script("highcharts-3d", $lib_url, array("jquery", "highcharts"), '1.0', true);
					wp_enqueue_script('highcharts-3d');
					break;
				case "exporting":
					//$lib_path = BC_PLUGIN_PATH .  "js/highcharts/exporting.js";
					//$lib_url = BC_PLUGIN_URL .  "js/highcharts/exporting.js";
					//if ($this->options['highcharts_cdn'] === '1' || !file_exists($lib_path) ) {
						$lib_url = "http://code.highcharts.com/modules/exporting.js";
					//}
	...
	public function register_flot_scripts() {
		...
		if ($this->options['flot_cdn'] === '1' || !file_exists($lib_path) ) {
			$lib_url = "http://www.flotcharts.org/flot/jquery.flot.min.js";
		}
		...
		if ( $this->library_options !== "") {
			...
			foreach ($arr as $value) {
				...
				if ($this->options['flot_cdn'] === '1' || !file_exists($lib_path) ) {
					$lib_url = "http://www.flotcharts.org/flot/jquery." . $name . ".min.js";
				}
	...
	public function register_scripts() {
		...
		if ( $this->add_library['zingchart'] ) {
			//$lib_path = BC_PLUGIN_PATH .  "js/zingchart/zingchart.min.js";
			//$lib_url = BC_PLUGIN_URL .  "js/zingchart/zingchart.min.js";
			//$lib_path = str_replace('\\', '/', $lib_path);
			//if ($this->options['zingchart_cdn'] === '1' || !file_exists($lib_path) ) {
...
//		if ( $this->add_library['amcharts'] ) {
//			wp_register_script("amcharts", ((file_exists(BC_PLUGIN_PATH .  "js/amcharts.js")) ? BC_PLUGIN_PATH  . "js/amcharts.js" : "http://www.amcharts.com/lib/3/amcharts.js") ,null, null, true);
