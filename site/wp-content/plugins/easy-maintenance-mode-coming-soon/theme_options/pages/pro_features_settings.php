<div class="block ui-tabs-panel active" id="option-ui-id-7" >
	<form method="post" id="easy_maintenance_theme_options_7">
...
">Comparison Table of Free And Pro Version</h3>
	...
	<br>	
		...
		<!--<div id="button_section">
			<input type="hidden" value="1" id="easy_maintenance_settings_save_7" name="easy_maintenance_settings_save_7" />
