...
<?php $current_options = wp_parse_args( get_option( 'easy_maintenance_mode_general_settings', array() ), general_setting() );
	...
	<form method="post" action="#section_general">
		<div id="heading">
			<table style="width:100%;"><tr>
				...
				<td style="text-align:right;">					
					<input class="button" type="submit" name="easy_maintenance_lite_settings_reset_1" value="<?php _e('Restore Defaults','easymaintenance'); ?>">&nbsp;
					<input class="button button-primary button-large" name="easy_maintenance_lite_settings_save_1" type="submit" value="<?php _e('Save Options','easymaintenance'); ?>">
				</td>
				</tr>
			</table>			
		</div>	
		...
		<div class="section">
            <div class="element">
            	<h3><?php _e('Select status','easymaintenance'); ?></h3>
                <input type="radio" name="status" value="0" id="status"  <?php if($current_options['status']=='0') echo 'checked' ?>/>&nbsp;<?php _e('Disabled','easymaintenance'); ?><br>
                <input type="radio" name="status" value="1" id="status" <?php if($current_options['status']=='1') echo 'checked' ?>/>&nbsp;<?php _e('Enable Maintenance Mode','easymaintenance'); ?>
            </div>
        </div>

        <div class="section">
            <div class="element">
            	<h3><?php _e('Headline','easymaintenance'); ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Description','easymaintenance'); ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Google Codes','easymaintenance'); ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3> <?php _e('Enter facebook url','easymaintenance'); ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter twitter url','easymaintenance'); ?></h3>
        ...
        <div class="section">
            <div class="element">
            	<h3><?php _e('Enter google-plus url','easymaintenance'); ?></h3>
